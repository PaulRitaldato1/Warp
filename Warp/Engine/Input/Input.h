...
inline HashMap<KeyCode, String> KeyCodeToStringMap =
{
    FOREACH_KEY(CREATE_KEY_STRINGS)
};
...
public:
    ...
    void SubscribeToKeyUp(KeyCode codeToSubTo, void (*func)(void));
    void SubscribeToKeyDown(KeyCode codeToSubTo, void (*func)(void));
