...
public:
	...
	virtual void SetPipelineState(URef<IPipelineState> State)	  = 0;
	virtual void SetVertexBuffer(URef<IBuffer> VertexBuffer)	  = 0;
	virtual void SetIndexBuffer(URef<IBuffer> IndexBuffer)		  = 0;
	virtual void BindResource(u32 Slot, URef<IResource> Resource) = 0;
