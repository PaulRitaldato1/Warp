...
void VKPipeline::Initialize(const PipelineDesc& desc)
{
	...
	rasterizer.polygonMode = (desc.rasterState.fillMode == RasterizerState::FillMode::Wireframe)
	...
	{
		case RasterizerState::CullMode::None:  rasterizer.cullMode = VK_CULL_MODE_NONE;      break;
		case RasterizerState::CullMode::Front: rasterizer.cullMode = VK_CULL_MODE_FRONT_BIT; break;
		case RasterizerState::CullMode::Back:  rasterizer.cullMode = VK_CULL_MODE_BACK_BIT;  break;
	}
	...
	VkFormat depthFmt = (desc.depthFormat != TextureFormat::Unknown)
