...
void D3D12Pipeline::InitializeWithDevice(ID3D12Device* device, const PipelineDesc& desc)
{
	...
	DYNAMIC_ASSERT(desc.renderTargetFormats.size() <= 8,
				   "D3D12Pipeline: max 8 render target formats");
	...
	for (const auto& elem : desc.inputLayout)
	{
		...
		d.AlignedByteOffset    = (elem.alignedByteOffset == InputElement::AppendAligned)
	...
	rast.FillMode                        = (desc.rasterState.fillMode == RasterizerState::FillMode::Wireframe)
	                                         ? D3D12_FILL_MODE_WIREFRAME : D3D12_FILL_MODE_SOLID;
	switch (desc.rasterState.cullMode)
	{
		case RasterizerState::CullMode::None:  rast.CullMode = D3D12_CULL_MODE_NONE;  break;
		case RasterizerState::CullMode::Front: rast.CullMode = D3D12_CULL_MODE_FRONT; break;
		default:                               rast.CullMode = D3D12_CULL_MODE_BACK;  break;
	}
	...
	auto ToD3DBlendFactor = [](BlendState::BlendFactor f) -> D3D12_BLEND
	{
		switch (f)
		{
			case BlendState::BlendFactor::Zero:         return D3D12_BLEND_ZERO;
			case BlendState::BlendFactor::One:          return D3D12_BLEND_ONE;
			case BlendState::BlendFactor::SrcColor:     return D3D12_BLEND_SRC_COLOR;
			case BlendState::BlendFactor::InvSrcColor:  return D3D12_BLEND_INV_SRC_COLOR;
			case BlendState::BlendFactor::SrcAlpha:     return D3D12_BLEND_SRC_ALPHA;
			case BlendState::BlendFactor::InvSrcAlpha:  return D3D12_BLEND_INV_SRC_ALPHA;
			case BlendState::BlendFactor::DestAlpha:    return D3D12_BLEND_DEST_ALPHA;
			case BlendState::BlendFactor::InvDestAlpha: return D3D12_BLEND_INV_DEST_ALPHA;
			case BlendState::BlendFactor::DestColor:    return D3D12_BLEND_DEST_COLOR;
			case BlendState::BlendFactor::InvDestColor: return D3D12_BLEND_INV_DEST_COLOR;
	...
	ds.DepthWriteMask                      = desc.enableDepthWrite
...
void D3D12ComputePipeline::InitializeWithDevice(ID3D12Device* device,
