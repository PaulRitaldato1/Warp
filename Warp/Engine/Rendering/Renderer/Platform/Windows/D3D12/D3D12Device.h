...
{
public:
	const char* GetAPIName() override { return "D3D12"; }
	...
	ID3D12Device2* GetNativeDevice() const { return m_device.Get(); }
	IDXGIFactory4* GetNativeFactory() const { return m_factory.Get(); }
