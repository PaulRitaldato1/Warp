...
{
public:
	// Called by D3D12Device::CreateSwapChain — the factory and queue must already exist
	void InitializeWithFactory(IDXGIFactory4* factory, ID3D12CommandQueue* queue,
